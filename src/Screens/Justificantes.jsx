  ...
  return (
    <div style={styles.container}>
      ...
      <div style={styles.content}>
        <h2 style={styles.title}>Formulario de Justificantes</h2>
        <form style={styles.form}>
          ...
          <label style={styles.label}>Padre o tutor</label>
          <input type="text" style={styles.input} />
          ...
          <button type="button" onClick={agregarFecha} style={styles.addButton}>
            + Agregar otra fecha
          </button>

          {/* Button pa adjuntar archivo */}
          ...
          {archivoNombre && (
            <span style={styles.archivoNombre}>Archivo: {archivoNombre}</span>
          )}
